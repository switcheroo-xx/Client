...
public class DeviceListAdapter extends BaseAdapter {
    ...
    public DeviceListAdapter(Context context, ArrayList<DeviceListItem> deviceListItems,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = mLayoutInflator.inflate(R.layout.device_item, parent, false);
        }
